...
export default class SearchFragment extends PageComponent {
    constructor(props){
        super(props);
    ...
    _signupCallback(){
        Toast2Android.show('点击了SearchFragment', Toast2Android.SHORT);
    ...
    render(){
        return(
            <View style={styles.view}>
               <NavigationBar title="SearchFragment" backOnPress={this._handleBack.bind(this)}/>
